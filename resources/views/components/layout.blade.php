...
<html lang="en">
  <head>
    ...
    <link rel="preload" href="https://fonts.googleapis.com/css2?family=Source+Sans+Pro:ital,wght@0,400;0,700;1,400;1,700&display=swap" as="style" />
  ...
  <body class="d-flex flex-column" style="min-height: 100vh;">
    <header class="header-bar mb-3">
      <div class="container d-flex flex-column flex-md-row align-items-center p-3">
        <h4 class="my-0 mr-md-auto font-weight-normal"><a href="/" class="text-white">FirstApp</a></h4>
        @auth
        <div class="flex-row my-3 my-md-0">
          <a href="#" class="text-white mr-2 header-search-icon" title="Search" data-toggle="tooltip" data-placement="bottom"><i class="fas fa-search"></i></a>
          <span class="text-white mr-2 header-chat-icon" title="Chat" data-toggle="tooltip" data-placement="bottom"><i class="fas fa-comment"></i></span>
          <a href="/profile/{{ auth()->user()->username }}" class="mr-3" title="My Profile" data-toggle="tooltip" data-placement="bottom">
            <img style="width: 32px; height: 32px; border-radius: 50%; border: 2px solid #fff; object-fit: cover;" src="{{ auth()->user()->avatar }}" />
          </a>
          <a class="btn btn-sm btn-outline-light mr-2" href="/create-post">
            <i class="fas fa-pencil-alt mr-1"></i> Write
          </a>
