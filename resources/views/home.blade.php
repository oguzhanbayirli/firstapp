        ...
        <div class="col-lg-5 pl-lg-5 pb-3 py-lg-5">
          <form action="/register" method="POST" id="registration-form">
            ...
            <div class="form-group">
              ...
              @error('username')
                <p class="m-0 text-danger small mt-1">{{ $message }}</p>
              @enderror
            </div>
            ...
            <button type="submit" class="py-3 mt-4 btn btn-lg btn-block" style="background-color: #f9322c; border-color: #f9322c; color: #fff;">
              <i class="fas fa-user-plus mr-2"></i> Sign up for FirstApp
            </button>
          </form>
        </div>
      </div>
