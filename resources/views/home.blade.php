    ...
    <div class="container py-md-5">
      <div class="row align-items-center">
        <div class="col-lg-7 py-3 py-md-5">
          <h1 class="display-3 mb-3">Remember Writing?</h1>
            ...
            <div class="card-body p-4">
              ...
              <form action="/register" method="POST" id="registration-form">
                ...
                <div class="form-group">
                  <label for="username-register" class="text-muted mb-2"><small>Username</small></label>
                ...
                <div class="form-group">
                  <label for="email-register" class="text-muted mb-2"><small>Email</small></label>
                ...
                <div class="form-group">
                  <label for="password-register" class="text-muted mb-2"><small>Password</small></label>
                ...
                <div class="form-group">
                  <label for="password-register-confirm" class="text-muted mb-2"><small>Confirm Password</small></label>
